...
export const fetchRecipeBySlugAsync = (uid: string, slug: string) => async (
  dispatch
) => {
...
export const addTagAsync = (recipe: Recipe, tag: string) => async (
  dispatch
) => {
  try {
...
export const deleteTagAsync = (recipe: Recipe, tag: string) => async (
  dispatch
) => {
  try {
...
export const fetchIngredientGroupsAsync = (id: string) => async (dispatch) => {
...
export const addIngredientGroupAsync = (
  recipe: Recipe,
  groupId: string
) => async (dispatch) => {
...
export const addStepAsync = (id: string, newStep: Step) => async (dispatch) => {
  dispatch(setRecipeUpdating(true));
  try {
